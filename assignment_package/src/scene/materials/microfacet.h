...
public:
    BlinnDistribution(float alphax, float alphay)
        : alphax(alphax), alphay(alphay) {}
...
class GaussianDistribution : public MicrofacetDistribution {
public:
    GaussianDistribution(float alphax, float alphay)
        : alphax(alphax), alphay(alphay) {}
...
class NishinoDistribution : public MicrofacetDistribution {
public:
    NishinoDistribution(float alphax, float alphay)
        : alphax(alphax), alphay(alphay) {}
...
class AshikhminShirley : public MicrofacetDistribution {
public:
    AshikhminShirley(float alphax, float alphay)
        : alphax(alphax), alphay(alphay) {}
